...
namespace BullsAndCows
{
    ...
    {   
        ...
        /// </summary>
        private const int SECRET_NUMBER_LENGHT = 4;
        ...
        public SecretNumber()
        {
            this.helpingNumber = new char[SecretNumber.SECRET_NUMBER_LENGHT];
        ...
        public void RevealDigit()
        {
            ...
            while (!isRevealed)
            {
                ...
                int digitForReveal = randomIndexGenerator.Next(0, SecretNumber.SECRET_NUMBER_LENGHT);

                if (this.helpingNumber[digitForReveal] == SecretNumber.HIDING_SYMBOL)
                {
        ...
        private void GenerateNumberForGuess()
        {
            ...
            for (int numberCount = 0; numberCount < SecretNumber.SECRET_NUMBER_LENGHT; numberCount++)
            {
        ...
        /// <summary>
        /// Initialize <see cref="helpingNumber"/> with hiding symbol <see cref="HIDING_SYMBOL"/>.
        /// </summary>
        private void GenerateHelpingNumber()
        {
            ...
            {
                this.helpingNumber[helpingNumberIndex] = SecretNumber.HIDING_SYMBOL;
            }
        } 
    }
}
